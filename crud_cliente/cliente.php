                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertar.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="DomicilioCliente" placeholder="Domicilio del cliente">
                                    <input type="text" class="form-control mb-3" name="CorreoCliente" placeholder="Correo del cliente">
